var app = new Vue({
    ...
    methods: {
        ...
        find1ThCategory: function (parentId) {
            axios.get('/content/find1ThCategory.shtml?parentId='+parentId).then(function (response) {
               app.Category = response.data.parentList
               app.Category2 = response.data.secondList
               app.Category3 = response.data.ThirdList
