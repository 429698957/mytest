            ...
            <div class="product-info">
                <div class="fl preview-wrap">
                    ...
                    <div class="zoom">
                        ...
                        <span class="jqzoom"><img jqimg="${imageList[0].url}" width="400px" height="400px"
                                                  src="${imageList[0].url}"/></span>
                        </div>
                        <!--下方的缩略图-->
                ...
                <div class="fr itemInfo-wrap">
                    ...
                    <div class="clearfix choose">
                        ...
                        <#list specification.attributeValue as attribute>
                             <dd><a href="javascript:;" :class="{selected:isSelected('${specification.attributeName}','${attribute}')}" @click="selectSpecifcation('${specification.attributeName}','${attribute}')">${attribute} <span title="点击取消选择">&nbsp;</span></a></dd>
                        </#list>
                            </dl>
                        </#list>
                        </div>
