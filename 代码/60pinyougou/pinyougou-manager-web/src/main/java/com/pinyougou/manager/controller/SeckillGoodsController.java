...
public class SeckillGoodsController {
	...
	public Result updateStatus(@RequestBody Long[] ids, String status){
		try {
			...
			Message message = new Message(messageInfo.getTopic(),messageInfo.getTags(),messageInfo.getKeys(), JSON.toJSONString(messageInfo).getBytes(RemotingHelper.DEFAULT_CHARSET));
